...
public interface ProducerServices {
	...
	public boolean changeAddress(String abbrev, String newAddress) throws Exception; // true if id found and patch done,
																						// false if not

	// normally we would implement a configurable logic to decide our service
	// implementation
